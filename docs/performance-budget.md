...
- The WebGL vendor chunk is isolated as `webgl`; the warning limit is set to `1200 kB` because Three.js, React Three Fiber, Drei, and postprocessing are expected costs for this project.
